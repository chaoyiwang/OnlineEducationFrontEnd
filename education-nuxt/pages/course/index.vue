...
export default {
  ...
  methods: {
    ...
    searchOne(subjectParentId, index) {
      //用点击的一级分类id和所有一级分类id进行比较，如果id相同，从一级分类里面获取相对应的二级分类
      // 把传递index值赋值给oneIndex为了active样式生效，出现选中的效果
      this.oneIndex = index;
      this.twoIndex = -1;
      ...
      for (let i = 0; i < this.subjectNestedList.length; i++) {
        //比较id是否相同，其中subjectParentId是点击的id
